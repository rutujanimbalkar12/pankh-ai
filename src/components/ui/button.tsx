...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary/90 hover:scale-105 shadow-soft hover:shadow-glow",
        ...
        // PankhAI Custom Variants
        wellness: "bg-gradient-wellness text-white hover:scale-105 shadow-wellness",
        hero: "bg-gradient-primary text-white hover:scale-105 shadow-glow hover:shadow-lg",
        pankhai: "bg-gradient-secondary text-white hover:scale-105 shadow-soft",
      },
      size: {
